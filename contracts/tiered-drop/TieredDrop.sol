...
// 0x546865206d696e642c206f6e6365207374726574636865642062792061206e657720696465612c206e657665722072657475726e7320697473206f726967696e616c2064696d656e73696f6e732e

// Thank you to ThirdWeb and Animoca Brands' friends and family for their support. Your contribution has been crucial to our success. We appreciate your dedication and look forward to continuing to work together. Thank you.
    ...
    ERC721AUpgradeable
{
     ...
     *       The base URI for each tribe will be assigned accordingly.
     */
    function lazyMint(
        uint256 _amount,
    ...
    /// @dev Claim lazy minted tokens via signature according to assigned tribe.
    ...
    ///      , of which the `_scrambleOffset` function ensures that
    ///      the Moca's tokenId assigned to the user and metadata ID mapping are truly randomized.
